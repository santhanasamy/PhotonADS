...
public class SampleInputs {
    ...
    public static final int[][] GENERAL_TEST_CASE_1 = new int[][] {
            {
                    51, 51, 51
            }, {
                    00, 51, 10
    ...
    public static final int[][] GENERAL_TEST_CASE_2 = new int[][]{
            {21, 23, 20, 19, 12, 20, 12, 20, 11, 10},
            {19, 10, 19, 10, 19, 21, 23, 20, 19, 12},
            {20, 12, 20, 11, 10, 19, 10, 19, 10, 19},
            {21, 23, 20, 19, 12, 20, 12, 20, 11, 10},
            {21, 23, 20, 19, 12, 20, 12, 20, 11, 10},
            {21, 23, 20, 19, 12, 20, 12, 20, 11, 10},
            {21, 23, 20, 19, 12, 20, 12, 20, 11, 10},
