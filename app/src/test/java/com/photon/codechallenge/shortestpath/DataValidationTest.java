...
public class DataValidationTest {
    ...
    private static final int[][] MAX_COLUMN_TEST = new int[][]{
            {3, 4, 4, 6, 7, 8, 9, 3, 4, 5, 6, 32, 2, 8, 9, 9,
                    4, 6, 7, 8, 9, 3, 4, 5, 6, 32, 2, 8, 9, 9, 2, 3,
                    4, 5, 8, 3, 4, 4, 6, 7, 8, 9, 3, 4, 5, 6, 32, 2,
                    8, 9, 9, 6, 7, 2, 8, 9, 9, 2, 3, 4, 5, 8, 6, 7,
                    3, 4, 4, 6, 7, 8, 9, 3, 4, 5, 6, 32, 2, 8, 9, 9,
                    4, 5, 8, 3, 4, 4, 6, 7, 8, 9, 3, 4, 5, 6, 32, 2,
                    3, 4, 4, 6, 7, 8, 9, 3, 4, 5, 6, 32, 2, 8, 9, 9,
                    3, 4, 4, 6, 7, 8, 9, 3, 4, 5, 6, 32, 2, 8, 9, 9,
    ...
    public void testMaxCostThreshold() {
        assertNotEquals("The told cost is not with in the acceptable limit",
                CommonUtils.MAX_COST, CommonUtils.findCost(MAX_COST_THRESHOLD_TEST));
    }

    @Test
    public void testMaxCostThresholdWithAcceptable() {
        assertEquals("The told cost is with in the acceptable limit",
                CommonUtils.MAX_COST, CommonUtils.findCost(MAX_COST_THRESHOLD_ACCEPTABLE_TEST));
    }
...
//    };
    ...
    public void test5X3MatrixWithNoValidPath() {
        //assertTrue(CommonUtils.findShortestPath(TEST_CASE_3) == 48);
    }
    ...
    public void testNonNumeric() {
        //assertTrue(CommonUtils.findShortestPath(TEST_CASE_6) == 11);
    }
